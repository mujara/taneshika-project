      ...
      <div className={`contents__mainInner --typeFullSize ${styles.typeParts}`}>
        <div className="inBase">
          <div className="inBase__inner">
            ...
            <div className={`tC sM-l ${styles.type016}`}>
              <a href="#">詳細はこちら</a>
            </div>
...
.simpleButton a:hover {
  color: #000;
  box-shadow: 0 3px 0 0 #ccc, 0 6px 4px -1px rgba(0, 0, 0, 0.3),
...
.simpleButton a:hover:active {
  box-shadow: 0 0px 0 0 #ccc, 0 3px 0 0 rgba(0, 0, 0, 0),
