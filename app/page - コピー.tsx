  ...
  return (
    <div className="home" id="home">
      ...
      <div id="contents" className="clearfix">
        <div className="homeArchiveBox" id="sectionHomeArchive">
          <div className="homeArchiveBox__title"><h2>Archive</h2></div>
          <div className="breadthScrollBox">
            <div className="inBase clearfix">
              <div className="homeArchiveBox__inner">
                <div className="homeArchiveBox__card --type01">
                  <a href="#" className="">
                    <p>2025.04.08</p>
                    <h3>
                  ...
                  {/* /.homeArchiveBox__card */}
                </div>
                <div className="homeArchiveBox__card --type02">
                  <a href="#" className="">
                    <p>2025.04.08</p>
                    <h3>
                      テストテストテストテストテストテストテストテストテストテスト
                ...
                <div className="homeArchiveBox__card --type03">
                  <a href="#" className="">
                    <p>2025.04.08</p>
                    <h3>
                      テストテストテストテストテストテストテストテストテストテスト
                ...
                <div className="homeArchiveBox__card --type04">
                  <a href="#" className="">
                    <p>2025.04.08</p>
                    <h3>
                      テストテストテストテストテストテストテストテストテストテスト
                ...
                <div className="homeArchiveBox__card --type05">
                  <a href="#" className="">
                    <p>2025.04.08</p>
                    <h3>
                      テストテストテストテストテストテストテストテストテストテスト
                ...
                <div className="homeArchiveBox__card --type06">
                  <a href="#" className="">
                    <p>2025.04.08</p>
                    <h3>
                      テストテストテストテストテストテストテストテストテストテスト
                ...
                <div className="homeArchiveBox__card --type07">
                  <a href="#" className="">
                    <p>2025.04.08</p>
                    <h3>
                      テストテストテストテストテストテストテストテストテストテスト
                ...
                <div className="homeArchiveBox__card --type08">
                  <a href="#" className="">
                    <p>2025.04.08</p>
                    <h3>
                ...
                <div className="homeArchiveBox__card --type09">
                  <a href="#" className="">
                    <p>2025.04.08</p>
                    <h3>
                      テストテストテストテストテストテストテストテストテストテスト
          ...
          <div className="inBase clearfix">
            <div className="button--type01"><a href="archive">More</a></div>
            {/* /.inBase */}
          </div>
          {/* /.homeArchiveBox */}
        </div>
        ...
        <div className="homeAboutBox">
          <div className="inBase clearfix">
            <div className="homeAboutBox__bg">
              <figure><img src="img/home/bgAbout01.png" alt="" /></figure>
              {/* /.homeAboutBox__bg */}
            </div>
            <div className="homeAboutBox__bg">
              <figure><img src="img/home/bgAbout02.png" alt="" /></figure>
              {/* /.homeAboutBox__bg */}
            </div>
            <div className="homeAboutBox__bg">
              <figure><img src="img/home/bgAbout03.png" alt="" /></figure>
              {/* /.homeAboutBox__bg */}
            </div>
            <div className="homeAboutBox__bg">
              <figure><img src="img/home/bgAbout04.png" alt="" /></figure>
              {/* /.homeAboutBox__bg */}
            </div>
            <div className="homeAboutBox__bg">
              <figure><img src="img/home/bgAbout05.png" alt="" /></figure>
              {/* /.homeAboutBox__bg */}
            </div>
            <div className="homeAboutBox__bg">
              <figure><img src="img/home/bgAbout06.png" alt="" /></figure>
              {/* /.homeAboutBox__bg */}
            </div>
            <div className="homeAboutBox__bg">
              <figure><img src="img/home/bgAbout07.png" alt="" /></figure>
              {/* /.homeAboutBox__bg */}
            </div>
            ...
            <div className="homeAboutBox__content">
              ...
              <p>
                御覧いただきありがとうございます。<br />当サイトは<span
                  className="name__ara"
                  ><span>十</span><span>十</span><span>亡</span
                  ><span>川</span></span
                ><span className="name__kawa"
                  ><span>一</span><span>一</span><span>一</span></span
                >が制作についての備忘録、<br />アウトプット、部品の保管庫として<br />利用しています。
              </p>
              <p>
                Thank you for visiting.<br />This site serves as a memo pad, an
                output platform, <br />and a storage repository for parts
                related to AraRiver's creations.
              </p>
              {/* /.homeAboutBox__content */}
            </div>
            <div className="homeAboutBox__portrait parallax--type05">
              <figure><img src="img/home/imgPortrait.png" alt="" /></figure>
              <figure><img src="img/home/imgEye.gif" alt="" /></figure>
